...
const SingleProduct = ({ items }) => {
  return (
    <div
      ...
      className=" mt-3 shadow-sm md:w-full lg:w-[300px]   md:mt-0 xl:w-[230px] sm:w-full md:shadow-none  shadow-gray-400 flex flex-col   space-y-4 overflow-hidden  text-center  "
    >
