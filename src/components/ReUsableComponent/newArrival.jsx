  ...
  return (
    <div className="new-arrival mt-16 w-[95%]  justify-self-center relative">
      ...
      <div>
        ...
        <button
          className="slider-buttons p-[8px] flex justify-center items-center border border-black lg:left-10 md:left-4 left-3 md:top-1/2 sm:top-[50%] top-[50%]"
          onClick={prevSlide}
        >
          <svg
        ...
        <button
          className="slider-buttons p-[8px] flex justify-center items-center border border-black lg:right-10  md:right-3 right-1 top-1/2"
          onClick={nextSlide}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
